...
from DataLoader.data_process import build_dataloader, collect_function
import yaml
from transformers import BertTokenizer
from onnxruntime import InferenceSession
import torch
from Model.Attention.multi_head import MultiHeadAttention
from Model.TransformerEncoderLayer.EncoderLayer import EncoderBlock, EncoderLayer
...
session = InferenceSession("utils/save/onnx/model.onnx")
