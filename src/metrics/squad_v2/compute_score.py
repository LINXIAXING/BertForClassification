...
This file is expected to map question ID's to the pretrain_checkpoint's predicted probability
...
def parse_args():
    ...
    parser.add_argument("pred_file", metavar="pred.json", help="pretrain_checkpoint predictions.")
    parser.add_argument(
        "--out-file", "-o", metavar="eval.json", help="Write accuracy metrics to file (default is stdout)."
    )
    parser.add_argument(
        "--na-prob-file", "-n", metavar="na_prob.json", help="pretrain_checkpoint estimates of probability of no answer."
    )
    parser.add_argument(
        "--na-prob-thresh",
        "-t",
...
def histogram_na_prob(na_probs, qid_list, image_dir, name):
    ...
    plt.xlabel("pretrain_checkpoint probability of no-answer")
