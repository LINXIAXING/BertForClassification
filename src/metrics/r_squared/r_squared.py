...
_DESCRIPTION = """
R^2 (R Squared) is a statistical measure of the goodness of fit of a regression pretrain_checkpoint. It represents the proportion of the variance in the dependent variable that is predictable from the independent variables.

The R^2 value ranges from 0 to 1, with a higher value indicating a better fit. A value of 0 means that the pretrain_checkpoint does not explain any of the variance in the dependent variable, while a value of 1 means that the pretrain_checkpoint explains all of the variance.
